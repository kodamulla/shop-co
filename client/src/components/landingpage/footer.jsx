  ...
  return (
    <footer className="w-full bg-[#0a0a0a] text-zinc-300 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div>
            ...
            <motion.div variants={itemVariants} className="flex items-center gap-2 font-bold text-2xl text-white mb-8">
              <img src="/logowhitezoom.svg" alt="ShopCo Logo" className="h-8 w-8" />
              <span>ShopCo</span>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-sm text-zinc-400 mb-10">
              <div>
                <p>1324 Yange Street, 4th Floor</p>
                <p>Toronto, ON, Canada</p>
              </div>
              <div>
                <p>+2(839)888-783-4825</p>
                <p>contact@shopco.com</p>
              </div>
            </motion.div>
          </div>
        ...
        {/* දකුණු පැත්තේ කොටස (පින්තූරය) */}
        {/* 'hidden lg:block' මගින් පොඩි තිර වලදී පින්තූරය පෙනීම නවත්වයි */}
        <motion.div 
        ...
        >
          {/* Grayscale අයින් කළා, දැන් කෙලින්ම පාටින් පෙනේවි */}
          <img
            src="/couple.jpeg"
            alt="Interior"

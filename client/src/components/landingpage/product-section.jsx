      ...
      <div className="container mx-auto md:px-6 px-4 ">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm md:text-base max-w-2xl mx-auto">
            Check out these amazing selections tailored just for you. Get them before they're gone!
          </p>
        </motion.div>
        ...
        >
          <p className="text-muted-foreground text-sm md:text-base max-w-xl mx-auto mb-5 px-4">
              ...
              <div className="w-full md:w-1/2 p-5 sm:p-6 md:p-10 lg:p-12 flex flex-col overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                ...
                <div className="pt-1 md:pt-2 flex gap-3 md:gap-4 shrink-0">
                  <button 
                    ...
                    className="flex-1 bg-black text-white h-12 md:h-16 rounded-lg md:rounded-xl font-bold uppercase tracking-widest text-xs md:text-sm hover:bg-gray-800 active:scale-[0.98] transition-all flex items-center justify-center gap-2 md:gap-3 shadow-lg hover:shadow-xl"
                  >
